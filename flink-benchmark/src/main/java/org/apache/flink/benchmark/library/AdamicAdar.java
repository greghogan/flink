		...
		switch(idType) {
			...
			case LONG: {
				...
				ji = graph
					...
					.run(new org.apache.flink.graph.library.similarity.AdamicAdar<LongValue, NullValue, NullValue>());
				} break;
			...
			case STRING: {
				...
				ji = graph
					...
					.run(new org.apache.flink.graph.library.similarity.AdamicAdar<StringValue, NullValue, NullValue>());
				} break;
		}
