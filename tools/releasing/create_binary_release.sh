...
if [ "$SCALA_VERSION" == "none" ] && [ "$HADOOP_VERSION" == "none" ]; then
  ...
  make_binary_release "hadoop29" "-Dhadoop.version=2.9.0" "2.11"
...
then
  ...
  make_binary_release "hadoop27" "-Dhadoop.version=2.7.5" "$SCALA_VERSION"
  make_binary_release "hadoop28" "-Dhadoop.version=2.8.3" "$SCALA_VERSION"
  make_binary_release "hadoop29" "-Dhadoop.version=2.9.0" "$SCALA_VERSION"
else
